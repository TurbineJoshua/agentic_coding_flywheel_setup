        ...
        <div className="relative flex flex-col items-center justify-end h-full z-10 w-28 sm:w-40">
          <motion.div 
            className={cn(
              ...
              isCodeBlowingHorizon 
                ...
                : "bg-gradient-to-t from-[#FF5500]/10 to-[#FF5500]/5 border-[#FF5500]/30 shadow-[0_0_40px_rgba(255,85,0,0.15)]"
            )}
          ...
          >
            ...
            <AnimatePresence>
              {isCodeBlowingHorizon && (
                <motion.div 
                  ...
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
                  className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] pointer-events-none"
                />
              )}
            </AnimatePresence>
            ...
            <FileCode2 className={cn(
              ...
              isCodeBlowingHorizon ? "text-[#FF5F56] drop-shadow-[0_0_10px_rgba(255,95,86,0.5)]" : "text-[#FF5500] drop-shadow-[0_0_10px_rgba(255,85,0,0.5)]"
            )} />
          </motion.div>
